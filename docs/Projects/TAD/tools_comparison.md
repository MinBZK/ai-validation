...
In [tools.md](tools.md) we have researched a few tools which we want to investigate further, this document is the next
step in that investigation. The checklist we will lay these tools against is written down at [index.md](index.md). The
Fulfilled column will give a numerical value based on the priority which can then be compared with the other tools per
section. The scoring is as follows: {M:4, S:3, C:2, W:1}.

## Summary of the comparison

| Tool                     | Requirement             | Score |
|:-------------------------|:------------------------|:------|
| AIVerify                 | Functionality           | 36    |
|                          | Reliability             | 13    |
|                          | Usability               | 9.4   |
|                          | Help & Documentation    | 2.8   |
...
|                          | Deployment              |       |
|                          | Legal & Compliance      |       |
| IBM Research 360 Toolkit | Functionality           |       |
|                          | Reliability             |       |
|                          | Usability               |       |
|                          | Help & Documentation    |       |
|                          | Performance Efficiency  |       |
...
| The tool offers options to discuss and document conversations. For example, to converse about technical tests or to collaborate on impact assessments.                                            | C         | 0         | Only conclusions can be logged                                                                                                                                                          |
...
| The tool recovers automatically from common failures.                                                                                  | S        | 1         | Commom failures like missing datasets or models are not breaking                                                                                                                                                         |
...
| The tool is scalable to accommodate increased user base and data volume. | S        | 1         | As it is built into a container it can be made scalable with Kubernetes                                              |
...
| The tool adheres to (local) data privacy regulations like GDPR and CCPA, ensuring the protection of user data.       | S        | 1         |                                                                                                                                     |
...
Introduction is written here [tools.md](tools.md#verifyml)

## IBM Research 360 Toolkit

Introduction is written here [tools.md](tools.md#ibm-research-360-toolkit)

## Hollisticai

Introduction is written here [tools.md](tools.md#hollisticai)
