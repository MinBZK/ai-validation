...
We use markdownlint to standardize markdown. [MarkDown lint](blob/main/CODE_OF_CONDUCT.md).

### Pre-commit

We use Pre-commit to enabled standardization. [Pre-commit](blob/main/.pre-commit-config.yaml).
