...
We have commit message conventions:
[Commit convention](https://minbzk.github.io/ai-validation/adrs/0007-commit-convention/)

### Markdown Lint

We use Markdown lint to standardize Markdown:
[Markdown lint config](https://github.com/MinBZK/ai-validation/blob/main/.markdownlint.yml).

### Pre-commit

We use pre-commit to enabled standardization:
[pre-commit config](https://github.com/MinBZK/ai-validation/blob/main/.pre-commit-config.yaml).
